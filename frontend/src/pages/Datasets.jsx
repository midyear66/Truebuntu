...
export default function Datasets() {
  ...
  return (
    <div>
      ...
      {showCreate && (
        <form onSubmit={createDataset} className="bg-white rounded-lg shadow p-5 mb-6">
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase">Mountpoint</th>
              <th className="px-4 py-3"></th>
            </tr>
          </thead>
          <tbody>
            {datasets.map(ds => (
              <tr key={ds.name} className="border-t hover:bg-gray-50">
                ...
                <td className="px-4 py-3 font-mono text-xs text-gray-500">{ds.mountpoint}</td>
